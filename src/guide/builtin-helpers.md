...
When the current item is itself an array, use [segment-literal notation](expressions.md#literal-segments) to read a
fixed index. Plain `this[0]` is not valid Handlebars syntax; write `this.[0]` instead:
